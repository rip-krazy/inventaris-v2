   ...
   <aside id="default-sidebar" class="relative top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
      <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
         <ul class="space-y-2 font-medium">
            ...
            <li>
               <a href="{{ url('admin\pengguna\pengguna') }}" class="flex items-center p-1 ml-5 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <li>
               <a href="{{ url('admin\Persetujuan\persetujuan') }}" class="flex items-center p-1 ml-5 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
...
<div class="max-w-4xl mx-auto">
    <h1 class="text-2xl font-bold mb-6 mt-10">Daftar Pengguna</h1>
    ...
    <table class="min-w-full mt-4">
        ...
        @foreach ($penggunas as $pengguna)
            <tr>
                  <td class="border px-4 py-2">{{ $pengguna->name }}</td>
                  <td class="border px-4 py-2">{{ $pengguna->username }}</td>
                  <td class="border px-4 py-2">
                     <img src="{{ asset('storage/' . $pengguna->photo) }}" alt="{{ $pengguna->name }}" class="h-12 w-12 object-cover rounded">
                  </td>
                  <td class="border px-4 py-2">{{ $pengguna->mapel }}</td>
                  <td class="border px-4 py-2">
                     <a href="{{ route('pengguna.edit', $pengguna->id) }}" class="text-blue-600">Edit</a>
