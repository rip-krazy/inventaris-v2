    ...
    <div class="bg-white rounded-xl shadow-lg p-6 mb-8 animate__animated animate__fadeIn">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <h1 class="text-3xl font-bold text-gray-800">
                <i class="fas fa-user-edit text-green-600 mr-3"></i>Edit Pengguna
            </h1>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-center justify-center">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-2xl font-bold text-gray-800">Opsional</p>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-center">
                    ...
                    <div class="text-center">
                        <p class="text-sm text-gray-600">Perubahan</p>
                        <p class="text-2xl font-bold text-gray-800">Disimpan</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden animate__animated animate__fadeInUp">
        <div class="px-6 py-8">
            <div class="text-center mb-8">
                ...
                <p class="text-gray-500 mt-2">Perbarui informasi pengguna berikut</p>
            </div>
                            ...
                            <tr class="hover:bg-green-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <select id="usertype" 
                                        ...
                                        <option value="user" {{ old('usertype', $pengguna->usertype) == 'user' ? 'selected' : '' }}>User</option>
                                        <option value="admin" {{ old('usertype', $pengguna->usertype) == 'admin' ? 'selected' : '' }}>Admin</option>
                                    </select>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    @error('usertype')
                            ...
                            <tr class="hover:bg-green-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-center">
                                    <input id="mapel" type="text" 
                                        ...
                                        name="mapel" value="{{ old('mapel', $pengguna->mapel) }}" required 
