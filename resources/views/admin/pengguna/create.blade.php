...
<div class="max-w-7xl mx-auto bg-white rounded-xl shadow-lg p-12 my-10 transform translate-x-4">
    ...
    <form action="{{ route('pengguna.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="text-center mt-8">
            <button type="submit" class="px-10 py-5 text-lg text-white bg-green-600 rounded-full bg-green-600 focus:outline-none focus:ring-2 bg-green-600 focus:ring-opacity-50 transition-all duration-300">Simpan</button>
        </div>
    </form>
</div>
</body>
