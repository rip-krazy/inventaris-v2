...
<div class="w-100 mx-24 mt-12 animate__animated animate__fadeIn">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8">
        ...
        <div class="mb-6 flex flex-wrap gap-4 items-center justify-between">
            ...
            <button class="bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition duration-150 flex items-center">
                    ...
                    <tr class="hover:bg-gray-50 transition duration-150">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                ...
                                <span class="text-gray-800 font-medium">{{ $entry['name'] }}</span>
                            </div>
                        </td>
