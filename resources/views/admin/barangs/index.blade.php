        ...
        <table class="min-w-full bg-white">
            <thead>
                <tr class="bg-green-600 text-white">
                    ...
                    <th class="py-4 px-6 text-center font-semibold">Detail & Aksi</th>
                </tr>
            </thead>
            <tbody>
                                    ...
                                    <div class="bg-gradient-to-br from-white to-gray-50 border-2 border-gray-200 rounded-lg p-4 hover:border-green-300 hover:shadow-md transition duration-200">
                                        ...
                                        <div class="flex gap-2 pt-3 border-t border-gray-200">
                                            <a href="{{ route('barangs.edit', $item) }}" 
                                               class="flex-1 px-3 py-2 bg-blue-500 text-white text-sm rounded-lg hover:bg-blue-600 focus:outline-none transition duration-200 flex items-center justify-center gap-2" 
                                               title="Edit">
                                                <i class="fas fa-edit text-xs"></i>
                                                <span>Edit</span>
                                            </a>
                                            <form action="{{ route('barangs.destroy', $item) }}" 
                                                  method="POST" 
                                                  class="flex-1" 
                                                  onsubmit="return confirm('Apakah yakin ingin menghapus {{ $item->kode_barang }}?')">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" 
                                                        class="w-full px-3 py-2 bg-red-500 text-white text-sm rounded-lg hover:bg-red-600 focus:outline-none transition duration-200 flex items-center justify-center gap-2" 
                                                        title="Hapus">
