...
<div class="w-full max-w-3xl mx-auto mt-16 p-8 bg-white rounded-lg shadow-lg animate__animated animate__fadeIn ml-80">
    ...
    <form action="{{ route('ruang.store') }}" method="POST" class="space-y-6">
        ...
        <div class="mb-5">
            ...
            <input type="text" name="name" id="name" class="border border-gray-300 rounded-md w-full p-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition ease-in-out duration-200 shadow-sm" required>
        </div>
        
        <!-- Input Keterangan -->
        <div class="mb-5">
            <label for="description" class="block text-gray-700 font-medium text-sm">Keterangan</label>
            <input type="text" name="description" id="description" class="border border-gray-300 rounded-md w-full p-3 text-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition ease-in-out duration-200 shadow-sm">
        </div>
