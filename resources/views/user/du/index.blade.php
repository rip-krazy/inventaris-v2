...
<div class="min-h-screen bg-gradient-to-br from-gray-100 to-gray-100 py-6 mr-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ml-32">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div class="md:col-span-2 bg-white p-6 rounded-xl shadow-md transform transition-all duration-500 opacity-100">
                <h3 class="text-lg font-semibold text-gray-700 mb-4 flex items-center">
                    <svg class="w-5 h-5 text-blue-500 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z" />
                        <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z" />
            ...
            <div class="bg-white p-6 rounded-xl shadow-md transform transition-all duration-500 opacity-100">
                <h3 class="text-lg font-semibold text-gray-700 mb-4 flex items-center">
                    <svg class="w-5 h-5 text-purple-500 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M2 10a8 8 0 018-8v8h8a8 8 0 11-16 0z" />
                        <path d="M12 2.252A8.014 8.014 0 0117.748 8H12V2.252z" />
                    </svg>
                    Status Barang
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        const chart = new Chart(ctx, {
                            ...
                            data: {
                                ...
                                datasets: [{
                                    data: [{{ $jumlahBarangBaik }}, {{ $jumlahBarangRusak }}, 25],
                                    backgroundColor: [
                                        'rgba(34, 197, 94, 0.7)',
                                        'rgba(239, 68, 68, 0.7)',
                                        'rgba(234, 179, 8, 0.7)'
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 transform transition-all duration-500 opacity-100">
                <div class="p-6 relative overflow-hidden">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-xl font-semibold text-gray-800">Barang Terfavorit</h2>
                            <p class="text-3xl font-bold text-red-600 mt-1">8</p>
                        </div>
                    </div>
                    <div class="mt-4">
                        <div class="text-sm font-medium text-gray-700">Top 3 barang:</div>
                        <div class="flex flex-col mt-2 space-y-2">
                            <div class="flex items-center justify-between">
                                <span class="text-xs text-gray-600">Laptop ASUS</span>
                                <span class="text-xs font-medium text-red-600">45 peminjaman</span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-xs text-gray-600">Proyektor</span>
                                <span class="text-xs font-medium text-red-600">32 peminjaman</span>
                            </div>
                            <div class="flex items-center justify-between">
                                <span class="text-xs text-gray-600">Camera DSLR</span>
                                <span class="text-xs font-medium text-red-600">28 peminjaman</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="bg-white p-6 rounded-xl shadow-md transform transition-all duration-500 opacity-100">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="text-sm text-gray-700">Anda meminjam <span class="font-medium text-gray-900">Laptop ASUS ROG</span></p>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="text-sm text-gray-700">Anda mengembalikan <span class="font-medium text-gray-900">Proyektor Epson</span></p>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="text-sm text-gray-700">Permintaan peminjaman <span class="font-medium text-gray-900">Camera DSLR</span> menunggu persetujuan</p>
                    ...
                    <div class="flex items-start">
                        <div class="flex-shrink-0 w-10 h-10 rounded-full bg-purple-100 flex items-center justify-center mr-3">
                            <svg class="w-5 h-5 text-purple-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M11 17a1 1 0 001.447.894l4-2A1 1 0 0017 15V9.236a1 1 0 00-1.447-.894l-4 2a1 1 0 00-.553.894V17zM15.211 6.276a1 1 0 000-1.788l-4.764-2.382a1 1 0 00-.894 0L4.789 4.488a1 1 0 000 1.788l4.764 2.382a1 1 0 00.894 0l4.764-2.382zM4.447 8.342A1 1 0 003 9.236V15a1 1 0 00.553.894l4 2A1 1 0 009 17v-5.764a1 1 0 00-.553-.894l-4-2z" />
                            </svg>
                        </div>
                        <div>
                            <p class="text-sm text-gray-700">Administrator menambahkan <span class="font-medium text-gray-900">10 barang baru</span> ke inventaris</p>
            ...
            <div class="bg-white p-6 rounded-xl shadow-md transform transition-all duration-500 opacity-100">
                <div class="flex justify-between items-center mb-4">
                    <h3 class="text-lg font-semibold text-gray-700 flex items-center">
                        <svg class="w-5 h-5 text-orange-500 mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd" />
                        </svg>
                        Jadwal Pengembalian
                    </h3>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tenggat</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr>
                                ...
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="text-sm text-gray-500">25 Feb, 2025</div>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                            ...
                            <tr>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">Microphone Wireless</div>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="text-sm text-gray-500">20 Feb, 2025</div>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                            ...
                            <tr>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">Tripod Kamera</div>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="text-sm text-gray-500">18 Feb, 2025</div>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
                            ...
                            <tr>
                                <td class="px-4 py-3 whitespace-nowrap">
                                    <div class="text-sm font-medium text-gray-900">Speaker Bluetooth</div>
                                </td>
                                <td class="px-4 py-3 whitespace-nowrap">
        ...
        <div class="bg-white p-6 rounded-xl shadow-md mb-8 transform transition-all duration-500 opacity-100">
            <h3 class="text-lg font-semibold text-gray-700 mb-4 flex items-center">
