...
<body class="bg-gray-100 font-sans">
    <div class="w-100 mx-16 bg-gradient-to-br from-white to-green-50 rounded-xl shadow-2xl p-10 my-6 animate__animated animate__fadeIn">
        ...
        <div class="mb-8 text-center animate__animated animate__fadeIn">
            ...
            <h1 class="text-4xl font-bold text-gray-800 mb-3">Request Pengembalian</h1>
            <p class="text-gray-600 text-lg max-w-2xl mx-auto">Lihat dan kelola semua permintaan pengembalian Anda</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-gray-50 overflow-hidden animate__animated animate__fadeInUp">
            ...
            <div class="bg-green-500 px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div class="flex items-center">
                    ...
                    <h2 class="text-2xl font-semibold text-white">Status Pengembalian</h2>
                </div>
            ...
            <div class="p-6">
                ...
                <div class="space-y-4" id="returnList">
                    ...
                    <div id="return-{{ $index }}" class="bg-white border border-gray-100 rounded-xl shadow-sm hover:shadow-md transition-all duration-300 ease-in-out transform hover:scale-[1.01]">
                        <div class="p-5">
                ...
                <div class="text-center py-16 animate__animated animate__fadeIn">
                    ...
                    <h3 class="text-xl font-medium text-gray-700 mb-2">Tidak ada permintaan pengembalian</h3>
                    <p class="text-gray-500 mb-6">Anda belum memiliki permintaan pengembalian</p>
        ...
        <div class="mt-6 bg-blue-50 rounded-xl p-4 border border-blue-100 flex items-center shadow-sm animate__animated animate__fadeIn animate__delay-1s">
            ...
            <div>
                ...
                <p class="text-blue-600 text-sm">Status pengembalian akan diperbarui secara real-time. Anda akan mendapat notifikasi untuk setiap perubahan status.</p>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelectorAll('[id^="return-"]').forEach(card => {
